...
Fix:
  ...
  * The requirement for the version of scipy has been updated.
...
Fix:
  ...
  * The application of the reaction XPath for current graphs has been fixed.
...
Fix:
  ...
  * The link flows for reversed ordering have been fixed.
